...
PaginationInput _$PaginationInputFromJson(Map<String, dynamic> json) =>
    PaginationInput(
      limit: _nullableFromJson(json['limit']),
      offset: _nullableFromJson(json['offset']),
    );

Map<String, dynamic> _$PaginationInputToJson(PaginationInput instance) =>
    <String, dynamic>{
      'limit': _nullableToJson(instance.limit),
      'offset': _nullableToJson(instance.offset),
    };
